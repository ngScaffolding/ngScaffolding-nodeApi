          ...
          .then(mongoClient => {
            ...
            rows.forEach(currentRow => {
              ...
              if (mongoDBSource.find) {
                ...
                obsCollection.push(
                  this.runFind(mongoClient, mongoDBSource.databaseName, mongoDBSource.collectionName, JSON.parse(replacedCommandString))
                );
              ...
              obsCollection.push(
                this.runAggregate(mongoClient, mongoDBSource.databaseName, mongoDBSource.collectionName, JSON.parse(replacedCommandString))
              );
            });
