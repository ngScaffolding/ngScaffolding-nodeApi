...
import { DocumentDBDataSource, DataResults } from '../models/index';
    ...
    return new Promise<any>((resolve, reject) => {
      ...
      ds.dataSource.getDataSource(dataSourceName).then(dataSouorce => {
        ...
        rows.forEach(currentRow => {
          ...
          obsCollection.push(docDB.executeQuery(docDbClient, docDBSource.databaseName, docDBSource.collectionName, replacedCommand));
        });
